...
### 网络产品推荐测试
```
用户: 我需要为50人的小公司推荐网络设备
AI: 根据您的需求，为50人的小公司推荐以下网络方案：

路由器：ASUS AX6000 (RT-AX88U) - WiFi 6企业路由器，支持高速无线连接
交换机：Netgear ProSAFE GS728TP - 24端口PoE+交换机，适合IP电话和摄像头
防火墙：pfSense SG-3100 - 开源防火墙，提供VPN和安全防护

预算范围：$1,000-2,000，包含完整的购买和实施指南。
```
